...
<header role="banner">
        ...
        <div class="container logo-wrap">
          <div class="row pt-5">
            <div class="col-12 text-center">
              ...
              <h1 class="site-logo mt-1"><a class="site-logo" href="index.html">Bloggers Den</a></h1>
            </div>
          </div>
        </div>
        ...
        <div class="categories text-center">
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            ?>
            <a href="includes/category.inc.php" class="mx-0 mt-1 btn btn-outline-dark"><?php echo $cat_title?></a>
            <?php
          }
          ?>
        </div>
